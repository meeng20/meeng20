    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="nav navbar-nav">
                <li><a class="item green" id="change_password_p" href="ownersetting.php">Change Password</a></li>
...
<?php
echo "<b>"."You are about to change your Email:"."<u>". $email1."</u>"."</b>";
?>
	 ...
	 if ($password1 == $password){
	 	if ($email != ""){
	 		if (filter_var($email, FILTER_VALIDATE_EMAIL) == true){
	 			if ($retype == $email){
	 				$sql = "UPDATE clientsrecord SET email ='$email' , activated = '0' WHERE id = '$id'";
                ...
                header('Location:emailownerupdate.php?msg='.$msg.'');
